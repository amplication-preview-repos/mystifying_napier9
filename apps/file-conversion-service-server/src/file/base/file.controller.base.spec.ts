  ...
  test("POST /files", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateUploaded: CREATE_RESULT.dateUploaded.toISOString(),
      ...
      .expect([
        {
          ...
          dateUploaded: FIND_MANY_RESULT[0].dateUploaded.toISOString(),
  ...
  test("GET /files/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateUploaded: FIND_ONE_RESULT.dateUploaded.toISOString(),
